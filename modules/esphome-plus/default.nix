...
in {
  ...
  config = mkIf cfg.enable {
    ...
    nixpkgs.overlays = [
      (final: prev: {
        esphome =
          (prev.esphome.override (o: {
            # FIXME: https://pr-tracker.nelim.org/?pr=429157
            platformio = o.platformio.override (old: {
              platformio-core = old.platformio-core.overridePythonAttrs {
                doCheck = false;
              };
            });
          })).overrideAttrs (o: {

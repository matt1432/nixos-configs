{
  ...
  loginCmd = enableAutologin: "${gettyCfg.loginProgram} ${baseLoginOptions}${lib.optionalString enableAutologin " -f -- ${gettyCfg.autologinUser}"}";
...
in {
  ...
  options = {
    services.kmscon = {
      ...
      package = mkPackageOption kmsconPkgs "kmscon" {};

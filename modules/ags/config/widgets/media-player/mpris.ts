...
export const ShuffleButton = (player: Mpris.Player, colors: Variable<Colors>) =>
    PlayerButton({
        player,
        colors,
        children: [
...
export const LoopButton = (player: Mpris.Player, colors: Variable<Colors>) =>
    PlayerButton({
        player,
        colors,
        children: [
...
export const NextButton = (player: Mpris.Player, colors: Variable<Colors>) =>
    PlayerButton({
        player,
        colors,
        children: [
